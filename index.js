...
// --- 核心配置变量 (仅保留代理服务所需) ---
const UUID = process.env.UUID || '5a27548babc0cfde6dff4b3da556d9d76ef603e66c34354e7fbfba55a1d5b5e6'; // 核心认证UUID
const DOMAIN = process.env.DOMAIN || 'gogogo.ygluck.com'; // 域名，用于订阅链接中的SNI和Host
const WSPATH = process.env.WSPATH || UUID.slice(0, 8); // 节点路径
const SUB_PATH = process.env.SUB_PATH || 'wifiyoutube'; // 获取节点的订阅路径
...
// Custom DNS (保留了原有的 Google DNS over HTTPS 解析逻辑)
